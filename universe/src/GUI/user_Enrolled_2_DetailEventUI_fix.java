...
public class user_Enrolled_2_DetailEventUI_fix extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					user_Enrolled_2_DetailEventUI_fix frame = new user_Enrolled_2_DetailEventUI_fix(users, result);
	 ...
	 * Create the frame.
	 */
	public user_Enrolled_2_DetailEventUI_fix(User users, String[] result) {
        ...
        JTextArea textArea_event_title = new JTextArea(result[6]);
        ...
        JTextArea textArea_event_desc = new JTextArea(result[7]);
        ...
        JLabel lbl_organizer = new JLabel(result[0]);
        ...
        JLabel lbl_event_category = new JLabel(result[1]);
        ...
        JTextArea textArea_step_by_step = new JTextArea(result[5]);
        ...
        JLabel lbl_quota = new JLabel(result[2]);
        ...
        JLabel lbl_capacity = new JLabel(result[3]);
        ...
        JLabel lbl_info_fee = new JLabel(result[4]);
