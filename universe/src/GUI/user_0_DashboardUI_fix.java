...
public class user_0_DashboardUI_fix extends JFrame {
	 ...
	 * Create the frame.
	 */
	public user_0_DashboardUI_fix(User users) {
		...
		txtWelcomeuser.setText("Welcome, " + users.getFullName() + "!");
		...
		JButton btn_EnrolledEvent = new JButton("Enrolled Event");
		btn_EnrolledEvent.setForeground(new Color(249, 247, 247));
		btn_EnrolledEvent.setBackground(new Color(0, 76, 152));
		btn_EnrolledEvent.setFont(new Font("Segoe UI", Font.BOLD, 12));
		btn_EnrolledEvent.setBorderPainted(false);
		
		designControl.setNoBorderButton(btn_EnrolledEvent);
		btn_EnrolledEvent.addActionListener(new ActionListener() {
        	public void actionPerformed(ActionEvent e) {
        		user_Enrolled_1_ViewEventUI_fix frame = new user_Enrolled_1_ViewEventUI_fix(users);
        		frame.setVisible(true);
        		designControl.setFrametoCenterOfScreen(frame);
        		dispose();
        	}
		...
		txtFullName = new JLabel(users.getFullName());
		...
		txtUsername = new JLabel(users.getUsername());
		...
		txtEmail = new JLabel(users.getEmail());
					...
					.addGroup(gl_panel_1.createParallelGroup(Alignment.TRAILING)
						...
						.addGroup(gl_panel_1.createSequentialGroup()
							.addGroup(gl_panel_1.createParallelGroup(Alignment.LEADING)
								...
								.addComponent(btn_EnrolledEvent, GroupLayout.PREFERRED_SIZE, 119, GroupLayout.PREFERRED_SIZE))
							.addGap(37)
				...
				.addGroup(gl_panel_1.createSequentialGroup()
					...
					.addGroup(gl_panel_1.createParallelGroup(Alignment.TRAILING)
						.addGroup(gl_panel_1.createSequentialGroup()
							...
							.addGap(18)
							.addComponent(btn_EnrolledEvent, GroupLayout.PREFERRED_SIZE, 50, GroupLayout.PREFERRED_SIZE))
						.addGroup(gl_panel_1.createSequentialGroup()
