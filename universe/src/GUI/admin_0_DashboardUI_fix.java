...
public class admin_0_DashboardUI_fix extends JFrame {
	 ...
	 * Create the frame.
	 */
	public admin_0_DashboardUI_fix(Admin admins) {
		...
		panel.setBounds(237, 150, 262, 117);
		...
		lbl_img.setBackground(new Color(249, 247, 247));
		...
		txtFullName = new JLabel(admins.getFullName());
		...
		txtUsername = new JLabel(admins.getUsername());
		...
		txtEmail = new JLabel(admins.getEmail());
		...
		txtWelcomeuser.setText("Welcome, " + admins.getFullName() + "!");
